...
function tv-bbcworld() { play "${URL_STREAM_BBCWORLD}" }
...
function tv-cbn() { play "${URL_STREAM_CNN}" }
function tv-cnn() { play "${URL_STREAM_CNN}" }
function tv-dm() { play "${URL_STREAM_DM}" }
function tv-hrt1() { play "${URL_STREAM_HRT1}" }
function tv-hrt2() { play "${URL_STREAM_HRT2}" }
function tv-hrt3() { play "${URL_STREAM_HRT3}" }
function tv-hrt4() { play "${URL_STREAM_HRT4}" }
